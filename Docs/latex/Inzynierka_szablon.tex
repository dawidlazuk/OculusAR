...
Niniejsza praca ma na celu przedstawienie możliwości wykorzystania gogli wirtualnej rzeczywistości do realizacji efektu rzeczywistości rozszerzonej. System stworzony w ramach tej pracy, umożliwia przechwytywanie obrazu z dwóch kamer, a następnie przesyłanie go do ludzkich oczu za pomocą gogli wirtualnej rzeczywistości.
Praca porusza także kwestie dotyczące problemów, powodowanych przez odmienne cechy obrazu cyfrowego i obrazu rzeczywistego. 

Integralną częścią pracy jest warstwa przetwarzania obrazu, umożliwiająca aplikowanie zdefiniowanych przekształceń do obrazu, podczas jego przesyłania z kamer do gogli.\\

\noindent \textbf{Słowa kluczowe:} wirtualna rzeczywistość, rozszerzona rzeczywistość, przetwarzanie obrazu
\end{abstract}
...
The purpose of this thesis is to present possible application of the  virtual reality gogles in implementation of augmented reality effect. The system created as part of this work allows to capture image from two cameras and then transfer it to human eyes using virtual reality goggles. The thesis also addresses issues related to problems caused by different features of digital image and real image.

The integral part of the thesis is the image processing layer, enabling the application of defined transformations to the image, during its transmission from cameras to goggles. \\

\noindent \textbf{Keywords:} virtual reality, augmented reality,image processing \end{abstract}}
